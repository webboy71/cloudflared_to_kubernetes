...
Sidecars example, easiest to deploy with helm (e.g. ```helm install cloudflare-sidecars .```)
...
![sidecars diagram](https://github.com/webboy71/cloudflared_to_kubernetes/blob/aea4218b4ff088046fb75a69b18df7783da601fa/images/cloudflare_tunnel_opt-Sidecar%20option.png)
